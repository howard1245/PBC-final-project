...
# 設定字體大小
small_font = pg.font.SysFont('uddigikyokashonruddigikyokashonpruddigikyokashonkr', 18)
med_font = pg.font.SysFont('uddigikyokashonruddigikyokashonpruddigikyokashonkr', 30)
large_font = pg.font.SysFont('uddigikyokashonruddigikyokashonpruddigikyokashonkr', 50)
...
def ios_android_function_i(system, function):
    if system == 'android':  # 手機系統選Android，執行Android的群組功能
        if function == '字數':
            ...
            android_i.inputfile2(Data.path)
            surf, surf_a, surf_d = android_i.calls()
            return surf, surf_a, surf_d
        elif function == '常用的字':
            android_i.inputfile(Data.path)
            surf_a, surf_d = android_i.wordclouds()
            return surf_a, surf_d
        elif function == '關係成分':
            android_i.inputfile(Data.path)
        ...
        if function == '字數':
            ...
            ios_i.inputfile2(Data.path)
            surf, surf_a, surf_d = ios_i.calls()
            return surf, surf_a, surf_d
        elif function == '常用的字':
            ios_i.inputfile(Data.path)
            surf_a, surf_d = ios_i.wordclouds()
            return surf_a, surf_d
        elif function == '關係成分':
            ios_i.inputfile(Data.path)
...
def individual():
    ...
    while not back:
        ...
        if Data.img == '字數' or Data.img == "常用的字":
            screen.blit(Data.surf_a, (30, 210))    # 圖片擺放位置
            screen.blit(Data.surf_d, (400, 210))
            pg.display.flip()

        elif Data.img == '句數' or Data.img == "通話":
            screen.blit(Data.surf, (50, 175))
            screen.blit(Data.surf_a, (30, 210))  # 圖片擺放位置
            screen.blit(Data.surf_d, (400, 210))
            pg.display.flip()
            ...
            screen.blit(Data.surf_a, (30, 210))  # 圖片擺放位置和!!!結論字串!!!
            screen.blit(Data.surf_d, (400, 210))
            pg.display.flip()
        ...
        for ev in pg.event.get():
            ...
            if ev.type == pg.MOUSEBUTTONDOWN:
                ...
                if button_word.collidepoint(ev.pos):
                    ...
                    Data.surf, Data.surf_a, Data.surf_d = ios_android_function_i(Data.system, "通話")
                    Data.img = "通話"

                elif button_often.collidepoint(ev.pos):
                    Data.surf_a, Data.surf_d = ios_android_function_i(Data.system, "常用的字")
                    Data.img = "常用的字"
