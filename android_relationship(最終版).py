...
for i in range(len(lines_for_word)):
    if lines_for_word[i][3] == name[0]:  # 如果名字與第一人相同
        if lines_for_word[i][4] == "[貼圖]"\
           or lines_for_word[i][4] == "[照片]"\
           or lines_for_word[i][4] == "[影片]"\
           or lines_for_word[i][4] == "[語音訊息]"\
           or lines_for_word[i][4] == "[檔案]"\
           or lines_for_word[i][4] == "未接來電"\
           or lines_for_word[i][4] == "相簿建立成功"\
           or lines_for_word[i][4] == "[聯絡資訊]"\
           or lines_for_word[i][4] == "[位置資訊]"\
           or lines_for_word[i][4][0:4] == "通話時間"\
           or lines_for_word[i][4] == "您已結束通話"\
           or lines_for_word[i][4] == "[禮物]"\
           or lines_for_word[i][4] == "無人接聽":
            pass
        else:
